...
banner = f"""{M}
   ...
   {M}• {P}Author {M}:\033[0;96m ALIENRAZOR
   {M}• {P}Github {M}: \033[0;96mAlienrazor
   {M}• {P}Team   {M}: \033[0;96mAlone Cyber
   {M}• {P}TOOL {M}:\033[0;96m TIKTOK VEDIO DOWNLOADER

 {M}• {P}Paste Link Video Tiktok {M}({H}https://vt.tiktok.com/balablaba{M})"""
		...
		try:
			...
			if 'true' in data:
				...
				if gas in ['Y','y']:
					...
					exit(f' {M}• {P}Thanks for using my tools  >_')
